      ...
      <result style="margin-bottom: 16px; margin-top: 48px" :is-success="false" :title="title" :description="description">
        ...
        <div>
          <div style="fontSize: 16px; fontWeight: 500; marginBottom: 16px">
            Your submission has the following errors:
          </div>
          <div style="margin-bottom: 16px">
            <a-icon class="error-icon" type="close-circle-o"/>
            Your account has been blocked
            <a style="margin-left: 16px">Unblock <a-icon type="right" /></a>
          </div>
          <div>
            <a-icon class="error-icon" type="close-circle-o"/>
            Your account is not eligible to apply
            <a style="margin-left: 16px">Update <a-icon type="right" /></a>
          </div>
        </div>
      </result>
    </a-card>
